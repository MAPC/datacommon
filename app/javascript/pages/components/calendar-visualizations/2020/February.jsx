...
const February = () => (
  <>
    ...
    <p>MAPC’s new study, <em><a href="https://metrocommon.mapc.org/reports/8">Crowded In and Priced Out: Why it’s so Hard to Find a Family-Sized Unit in Greater Boston</a></em> found that in Boston and a dozen surrounding cities and towns, households with children only occupy 39 percent of larger units. Instead, families squeeze into smaller places, two or more to a bedroom.</p>
    ...
    <p>Read the full report at <a href="https://metrocommon.mapc.org/reports/8">mapc.ma/familyunits.</a></p>
  </>
);
