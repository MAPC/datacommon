        ...
        <>
          <section className="calendar-spotlight">
            ...
            <div className="calendar-spotlight__info">
              <p>Welcome to the MAPC 2020 Calendar—which for the first time in the history of our calendar is in the form of a monthly interactive digital publication and a beautiful year-at-a-glance printed poster. Our monthly maps and data visualizations will be, as ever, insightful, visually arresting, and covering a range of vital topics.</p>
