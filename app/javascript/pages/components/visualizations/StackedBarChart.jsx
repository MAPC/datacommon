...
class StackedBarChart extends React.Component {
  ...
  renderChart() {
    ...
    const clippedMaxLeftLabel =
      this.props.horizontal && maxLeftLabel > LEFT_LABEL_MAX
        ? LEFT_LABEL_MAX
        : maxLeftLabel;
    ...
    const valAxis = (
      this.props.horizontal ? d3.axisBottom(valScale) : d3.axisLeft(valScale)
    )
      .ticks(10)
      .tickSize(0)
      .tickPadding(10)
    ...
    const catAxis = (
      this.props.horizontal ? d3.axisLeft(catScale) : d3.axisBottom(catScale)
    )
      .tickSize(0)
      .tickPadding(10)
      .ticks(10)
    ...
    const [xAxis, yAxis] = this.props.horizontal
      ? [valAxis, catAxis]
      : [catAxis, valAxis];
    ...
    layer
      ...
      .enter()
      .append("rect")
      .attr(this.props.horizontal ? "y" : "x", (d) =>
        replaceNaN(catScale(d.data.y) + realignment)
      )
      .attr(this.props.horizontal ? "x" : "y", (d) =>
        replaceNaN(this.props.horizontal ? valScale(d[0]) : valScale(d[1]))
      )
      .attr(this.props.horizontal ? "width" : "height", (d) =>
        replaceNaN(
    ...
    layer
      ...
      .on("mouseover", (event, d) => {
        ...
        const value =
          parseFloat(event.data[series]) < 1
            ? event.data[series].toFixed(3)
            : event.data[series];
    ...
    const yAxisG = this.gChart
      .append("g")
      .attr("class", "axis axis-y")
      .call(yAxis);
    if (
      this.props.wrapLeftLabel &&
      this.props.horizontal &&
    ...
    this.chart
      ...
      .text(
        this.props.horizontal ? this.props.xAxis.label : this.props.yAxis.label
      );
    ...
    this.chart
      ...
      .style("text-anchor", "middle")
      .text(
        this.props.horizontal ? this.props.yAxis.label : this.props.xAxis.label
      );
