...
const November = () => (
  <>
    ...
    <p>
      As with most things, however, COVID-19 has flipped the script. With isolation, four-legged companions have become highly coveted. And it may be that for those suddenly working from home, the logistics of the lunchtime walk aren’t quite so daunting. In April, the Massachusetts Society for the Prevention of Cruelty to Animals
      {' '}
      <a href="https://www.nbcboston.com/news/coronavirus/mspca-sees-increase-in-adoptions-amid-covid-19-pandemic/2112698/" className="calendar-viz__link">reported a 20 percent increase in pet adoptions.</a>
    </p>
    <p>COVID-19 has also affected the pet “pipeline.” Many canine adoptees come from southern states, where more lenient neuter and spay laws result in a surplus of animals in need of homes. With travelers from most states requiring either a 14-day quarantine or negative COVID-19 test upon entering Massachusetts, and with temporary shelter closures both here and in the south, fewer animals have been transported than in a normal year.</p>
    <p>Despite all this, there are still adoptable dogs in Massachusetts. We used the Petfinder API to find dozens of available pets from shelters and organizations all around the Commonwealth. Click around the map to see who is up for adoption and where. You might just meet your new best friend!</p>
  </>
);
