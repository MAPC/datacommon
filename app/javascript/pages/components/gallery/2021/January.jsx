        ...
        >
          ...
          >
            ...
            <ul className="map-legend__resource-list">
              ...
              <li className="map-legend__resource map-legend__entry">
                <a className="map-legend__link" href="https://mapc365.sharepoint.com/:f:/s/DataServicesSP/ErKkXSLH_iBOlDhJrTXldrYBIIZ4ZXe4Bkw7OyVapVpX3Q?e=iRkWVB">Spatial data (.shp)</a>
              </li>
              <li className="map-legend__resource map-legend__entry">
